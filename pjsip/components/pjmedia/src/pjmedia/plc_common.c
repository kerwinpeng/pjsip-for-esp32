...
{
    pjmedia_plc *plc;
    plc_alg *plc_wsola = PJ_POOL_ALLOC_T(pool, plc_alg);
    plc_wsola->plc_create = &plc_wsola_create;
    plc_wsola->plc_save = &plc_wsola_save;
    plc_wsola->plc_generate = &plc_wsola_generate;
