...
#include <pj/log.h>
#include <pj/rand.h>
#include <pj/pj_string.h>	    /* pj_memset() */
					     ...
					     pjmedia_snd_port **p_port)
{
    ...
    param.base.clock_rate = 8000;
    param.base.channel_count = 1;
    param.base.samples_per_frame = param.base.clock_rate * 20 / 1000;
    param.base.bits_per_sample = 16;
    param.base.input_latency_ms = PJMEDIA_SND_DEFAULT_REC_LATENCY;
    param.base.output_latency_ms = PJMEDIA_SND_DEFAULT_PLAY_LATENCY;
