					 ...
					 pjmedia_echo_state **p_echo )
{
               ...
               (options & PJMEDIA_ECHO_ALGO_MASK) == PJMEDIA_ECHO_DEFAULT)
    {
        ...
        struct ec_operations *echo_supp_op = PJ_POOL_ALLOC_T(pool, ec_operations);
        echo_supp_op->name = "Echo suppressor";
        echo_supp_op->ec_create = &echo_supp_create;
        echo_supp_op->ec_destroy = &echo_supp_destroy;
        echo_supp_op->ec_reset = &echo_supp_reset;
        echo_supp_op->ec_cancel = &echo_supp_cancel_echo;
        echo_supp_op->ec_playback = NULL;
        echo_supp_op->ec_capture = NULL;
        echo_supp_op->ec_get_stat = &echo_supp_get_stat;
