					       ...
					       pjmedia_transport **p_tp)
{
    ...
    pjmedia_transport_op tp_adapter_op1 = 
    {
        &transport_get_info,
        NULL,
        &transport_detach,
    ...
    pjmedia_transport_op *tp_adapter_op = PJ_POOL_ALLOC_T(pool, pjmedia_transport_op);
    pj_memcpy(tp_adapter_op, &tp_adapter_op1, sizeof(pjmedia_transport_op));
