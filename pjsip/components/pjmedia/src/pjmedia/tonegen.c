					    ...
					    pjmedia_port **p_port)
{
	...
	pjmedia_tone_digit_map digit_map1 = 
	{
		16,
		{
		{ '0', 941,  1336 },
	...
	/* Default digit map is DTMF */
	pjmedia_tone_digit_map *digit_map = PJ_POOL_ALLOC_T(pool, pjmedia_tone_digit_map);
	pj_memcpy(digit_map, &digit_map1, sizeof(pjmedia_tone_digit_map));
