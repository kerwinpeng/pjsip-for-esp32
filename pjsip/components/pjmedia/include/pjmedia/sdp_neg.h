...
/**
 * Enumeration of customized SDP format matching option flags. more info.
 */
...
/**
 * The declaration of customized SDP format matching callback.
 *
 ...
 * for the specified format is registered,  it will be called for
