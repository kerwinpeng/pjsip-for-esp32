...
static int init_status_phrase(pj_str_t *status_phrase)
{
    unsigned i;
...
{
    pj_str_t status_phrase[710] = {0};
 
    init_status_phrase(status_phrase);
...
static int pjsip_contact_hdr_print( pjsip_contact_hdr *hdr, char *buf, 
				    pj_size_t size)
{
    pj_str_t *hname = pjsip_cfg()->endpt.use_compact_form? 
			    &hdr->sname : &hdr->name;
